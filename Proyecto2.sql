...
-- PARTE 2
/*
Procedimiento almacenado para realizar la matrÃ­cula de un de un estudiante en un grupo especÃ­fico. En este procedimiento es donde se debe hacer la validaciÃ³n de los requisitos. En caso de que el estudiante no cumpla los requisitos de la materia que desea matrÃ­cula entonces se debe mostrar un mensaje significativo en donde se indique cuÃ¡l es el requisito que tiene pendiente. Para la implementaciÃ³n de esta validaciÃ³n puede usar cualquiera de los elementos vistos en clase.
*/
