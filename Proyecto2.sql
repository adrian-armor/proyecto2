...
-- PARTE 2
/*
Procedimiento almacenado para realizar la matr√≠cula de un de un estudiante en un grupo espec√≠fico. En este procedimiento es donde se debe hacer la validaci√≥n de los requisitos. En caso de que el estudiante no cumpla los requisitos de la materia que desea matr√≠cula entonces se debe mostrar un mensaje significativo en donde se indique cu√°l es el requisito que tiene pendiente. Para la implementaci√≥n de esta validaci√≥n puede usar cualquiera de los elementos vistos en clase.
*/
...
/*
Calcula el ponderado de todos los estudiantes en un aÒo determinado.
Solo el ˙ltimo periÛdo matriculado con dos decimales de precisiÛn.
*/
